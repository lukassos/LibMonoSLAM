...
GROUND_TRUTH_FILE = "/media/lukassos/Library/DataSets/3D/rgbd_dataset_freiburg1_desk/groundtruth.txt" #Ground truth file for the camera position, as given in the computer vision dataset from Technische Universität München
